...
@bd_1 = BulkDiscount.create!(name: "Going Out of Business", discount: 0.2, threshold: 10, merchant: @merchant1)
@bd_2 = BulkDiscount.create!(name: "Another Day Another Sale", discount: 0.3, threshold: 15, merchant: @merchant1)
